...
export default function LoginPage() {
  ...
  return (
    <>
      <SEO
        title="Login - EquipRent"
        description="Login to your EquipRent account to access your dashboard, bookings, and manage your listings."
      />
          ...
          <Card className="w-full max-w-md p-8">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-muted-foreground">
                Login to your EquipRent account
              </p>
            </div>
